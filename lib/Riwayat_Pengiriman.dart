                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text("Pengiriman"+data.NamaPengirim, style: 
                        TextStyle(
                          fontSize: 24,
                      ...
                      Container(
                        ...
                        child: Text("Jenis Barang : "+data.JenisBarang, style: 
                        TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold
                        ),),
                      ...
                      Container(
                        margin: EdgeInsets.only(left: 70),
                        child: Text("Penerima        : "+data.NamaPenerima, style: 
                        TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold
                        ),),),
                      Container(
                        margin: EdgeInsets.only(left: 70),
                        child: Text("Waktu              : "+DateFormat('dd-MM-yyyy').format(DateTime.now()),style: 
                        TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold
                        ),),),
                      Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: Text("Paket telah diterima",style: 
                        TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.bold,
                      ...
                      Row(
                        children: [
                          Container(
                            margin: EdgeInsets.only(top: 80, left: 40, bottom: 0.01),
                            child: Text("1 barang",style: 
                        TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.bold
                        ),),
                          ...
                          Container(
                            margin: EdgeInsets.only(top: 80, left: 20, bottom: 0.01),
                            child: Text("Total Harga: Rp17.000",style: 
                        TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.bold
                        ),),
...
Stream<List<Data>> readData() => FirebaseFirestore.instance.collection("Kirim_Paket")
