import 'package:first_project/saldo.dart';
import 'package:first_project/scanqrcode.dart';
...
class E_Wallet extends StatelessWidget {
  ...
  MaterialPageRoute(builder:(context){return Saldo();},),);
                                  },
                                  child: Container(
                                ...
                                Container(
                                      child: Text("Isi Saldo", style: GoogleFonts.dosis(textStyle: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 17,
                                      )),),
                                    ),
                                ...
                                InkWell(
                                  onTap: () {
                                    Navigator.push(context,
  MaterialPageRoute(builder:(context){return qrscanner();},),);
                                  },
                                  child: Container(
                                    padding: EdgeInsets.fromLTRB(30, 10, 6, 10),
                                ...
                                Container(
                                      child: Text("Pembayaran", style: GoogleFonts.dosis(textStyle: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 17,
                                      )),),
                                    ),
