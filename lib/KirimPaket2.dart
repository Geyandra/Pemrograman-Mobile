                  ...
                  child: Column(
                    children: [
                      Container(
                        child: Column(
                          children: [
                            Field(screenWidth: screenWidth, text: 'Berat', control: controlBerat,),
                            Field(screenWidth: screenWidth, text: 'Nama Barang', control: controlNamaBarang,),
                            Container(
                              margin: EdgeInsets.only(top: 20, left: 40),
                              alignment: Alignment.topLeft,
                              child: Text("Ukuran Barang", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                            ),
                            Container(
                            ...
                            UkuranBarang(screenWidth: screenWidth, text: """
    Ukuran S
max (20 x 20 x 8 cm)
""", top: 40,
                            ),
...
""", top: 5,
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                onPressed: (){
                                  final data = Data(Berat: controlBerat.text, NamaBarang: controlNamaBarang.text, Ukuran: 'M');
