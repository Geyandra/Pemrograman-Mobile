    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: [
          ...
          BottomNavigationBarItem(
            label: "Profile",
            icon: IconButton(onPressed: (){Navigator.push(context,
  MaterialPageRoute(builder:(context){return profilekurir();},),);}, icon: Icon(Icons.person)))
        ]),
      body: 
...
style: TextStyle(
  ...
  MaterialPageRoute(builder:(context){return Order();},),);
                            },
                            child: Row(
                              children: [
                                // Text("data"),
                                ...
                                Text("Order Paket", style: TextStyle(
                                  fontSize: 22,
                      ...
                      child: Card(
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.push(context,
  MaterialPageRoute(builder:(context){return E_Wallet_Kurir();},),);
                              },
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                children: [
                                  Text("Dompet Digital",style: TextStyle(
                                    fontSize: 22,
                                    fontWeight: FontWeight.bold
                                  ),),
                                  Container(
                      ...
                      child: Card(
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.push(context,
                                MaterialPageRoute(builder:(context){return BuktiPengiriman();},),);
                              },
                              child: Row(
                                children: [
                                  // Text("data"),
                                  ...
                                  Text("Bukti Pengiriman", style: TextStyle(
                                    fontSize: 22,
                                    fontWeight: FontWeight.bold
                                  ),),
                                ],
