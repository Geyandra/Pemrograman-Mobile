            ...
            Column(
              children: [
                Container(
                  ...
                  child: Text("Pengiriman", style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold),)),
                Container(
                  ...
                  child: Column(
                    children: [
                      Container(
                        child: Column(
                          children: [
                            Field(screenWidth: screenWidth, text: 'Jenis Barang',control: controlJenisBarang,),
                            Field(screenWidth: screenWidth, text: 'Nama Pengirim', control: controlNamaPengirim,),
                            Field(screenWidth: screenWidth, text: 'Penjemputan', sufficon: Icon(Icons.location_on), control: controlPenjemputan,),
                            Field(screenWidth: screenWidth, text: 'Nama Penerima', control: controlNamaPenerima,),
                            Field(screenWidth: screenWidth, text: 'Nomer HP', control: controlNomerHP,),
                            Field(screenWidth: screenWidth, text: 'Tujuan', sufficon: Icon(Icons.location_on), control: controlTujuan,),
                            Container(
...
""", style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),),
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                onPressed: (){
                                  final data = Data(
                                    NamaPengirim: controlNamaPengirim.text, 
                                    Penjemputan: controlPenjemputan.text, 
                                    NamaPenerima: controlNamaPenerima.text, 
                                    Tujuan: controlTujuan.text, 
                                    NomerHP: int.parse(controlNomerHP.text), 
                                    JenisBarang: controlJenisBarang.text);
                                    createData(data);
                                  Navigator.push(context, MaterialPageRoute(builder: (context){return KirimPaket2();},),);}, 
                                child: Text("NEXT"),
